...
Ans : The CPU when executes the function code, stores the function return value in a
      ...
      to actually execute the functions code. This overhead occurs for small functions because
...
/*
    ...
    errors from the linker. That error will occur if you put the inline functions
